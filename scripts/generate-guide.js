...
2. 본문 구조
   - 본문 시작 부분(목차 바로 위)에 썸네일 이미지(`![대표 이미지](https://images.unsplash.com/photo-1432821596592-e2c18b78144f?auto=format&fit=crop&w=800&q=80)`)를 반드시 삽입하세요.
   - 이미지 바로 아래에 클릭하면 해당 단락으로 이동할 수 있는 **마크다운 목차(Table of Contents)**를 반드시 추가하세요.
