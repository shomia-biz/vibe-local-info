      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-[2rem] shadow-sm border border-gray-100 text-gray-700 leading-relaxed">
          ...
          <div className="border-t border-gray-100 pt-6 mt-8">
            ...
            <p>🌐 사이트: 수도권 모아팁스(<a href="https://moatips.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-orange-600 transition-colors">moatips.com)</a></p>
          </div>
