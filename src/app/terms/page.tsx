    ...
    <main className="min-h-screen bg-[#FFFBF7] py-16">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-[2rem] shadow-sm border border-gray-100 text-gray-700 leading-relaxed">
          ...
          <p className="mb-6">본 약관은 수도권 모아팁스(이하 "모아팁스")가 제공하는 정보 서비스(이하 "서비스")를 이용자가 이용함에 있어, "모아팁스"와 이용자의 권리, 의무 및 책임 사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>

          <h2 className="text-xl font-bold text-gray-900 mb-2">제2조 (용어의 정의)</h2>
          <ul className="list-none pl-0 mb-6 space-y-2">
            <li>① "서비스"란 "모아팁스"가 공공데이터 등을 활용하여 웹사이트를 통해 제공하는 축제·행사, 지원금·혜택 정보 및 생활 정보 콘텐츠 일체를 의미합니다.</li>
            <li>② "이용자"란 "모아팁스"의 웹사이트에 접속하여 본 약관에 따라 "모아팁스"가 제공하는 "서비스"를 이용하는 자를 말합니다.</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-900 mb-2">제3조 (서비스의 내용 및 정보의 한계)</h2>
          <p className="mb-2">① "모아팁스"는 공공데이터포털(data.go.kr) 및 각 지방자치단체의 공식 API, 공식 공고 등을 활용하여 수도권(서울·경기·인천) 지역의 다음 각 호의 정보를 제공합니다.</p>
          <ul className="list-disc pl-5 mb-4 space-y-1">
            <li>수도권 문화행사 및 축제 정보</li>
            <li>정부·지자체 지원금 및 혜택 정보</li>
            <li>블로그 형태의 생활 정보 콘텐츠</li>
          </ul>
          <p className="mb-2">② "모아팁스"가 제공하는 정보는 정확성을 위해 최선을 다하나, 원본 데이터의 변경, API 오류, 연동 지연 등으로 인해 실제 공고 내용과 일시적인 차이가 발생할 수 있습니다.</p>
          ...
          <ul className="list-none pl-0 mb-6 space-y-2">
            <li>① 본 약관은 "모아팁스"가 서비스 화면에 게시하거나 기타의 방법으로 이용자에게 공지함으로써 효력이 발생합니다.</li>
            <li>② "모아팁스"는 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.</li>
            <li>③ "모아팁스"가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 서비스 초기화면에 그 적용일자 7일 이전(이용자에게 불리하거나 중대한 사항의 변경은 30일 이전)부터 적용일 전일까지 공지합니다.</li>
            <li>④ "모아팁스"가 전항에 따라 개정약관을 공지하면서 '이용자가 공지 기간 내에 거부 의사를 표시하지 않으면 동의한 것으로 본다'는 뜻을 명확하게 공지하였음에도 이용자가 명시적으로 거부 의사를 표시하지 아니한 경우, 이용자가 개정약관에 동의한 것으로 봅니다.</li>
          </ul>
          ...
          <ul className="list-none pl-0 mb-6 space-y-2">
            <li>① "모아팁스"는 Google AdSense, 쿠팡 파트너스 등 제3자의 광고 및 제휴 서비스를 포함하고 있습니다.</li>
            <li>② 서비스 내에 포함된 외부 웹사이트로의 링크는 이용자의 편의를 위해 제공되는 것이며, "모아팁스"는 연결된 외부 웹사이트의 독립성, 독자성 및 해당 사이트가 제공하는 정보·상품·서비스의 유효성에 대해 보증하거나 책임을 지지 않습니다.</li>
          ...
          <ul className="list-none pl-0 mb-6 space-y-2">
            <li>① "모아팁스"는 천재지변, 전시, 사변, 정부의 규제, 통신사업자의 서비스 중단, 디도스(DDoS) 공격, API 제공 기관의 시스템 장애 등 불가항력적인 사유로 서비스를 제공할 수 없는 경우, 이로 인해 이용자에게 발생한 손해에 대해 책임을 지지 않습니다.</li>
            <li>② "모아팁스"는 고의 또는 중대한 과실이 없는 한, 이용자가 서비스를 통해 얻은 정보(오류, 누락, 지연된 정보 포함)를 신뢰하여 내린 결정이나 조치로 인해 발생한 손해에 대해 책임을 지지 않습니다.</li>
            <li>③ 이용자가 지원금 신청 기간을 초과하거나 서류 미비, 자격 요건 불충족 등으로 인해 발생한 불이익 및 혜택 미수령에 대하여 "모아팁스"는 책임을 지지 않습니다.</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-900 mb-2">제10조 (서비스의 변경 및 중단)</h2>
          <ul className="list-none pl-0 mb-6 space-y-2">
            <li>① "모아팁스"는 운영상, 기술상의 필요 또는 정부 정책 및 API 제공 기관의 사정에 따라 서비스의 전부 또는 일부를 변경하거나 중단할 수 있습니다.</li>
            <li>② 서비스의 중대한 변경 또는 중단이 있는 경우, "모아팁스"는 서비스 내 공지사항을 통해 사전에 이용자에게 고지합니다. 다만, 예측할 수 없는 시스템 장애 등의 긴급한 사유가 있는 경우에는 사후에 고지할 수 있습니다.</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-900 mb-2">제11조 (준거법 및 관할법원)</h2>
          <ul className="list-none pl-0 mb-8 space-y-2">
            <li>① 본 약관의 해석 및 "모아팁스"와 이용자 간의 분쟁에 대해서는 대한민국 법률을 준거법으로 합니다.</li>
            <li>② "모아팁스"와 이용자 간에 발생한 분쟁에 관한 소송은 민사소송법상의 관할법원을 제1심 법원으로 합니다.</li>
          </ul>
